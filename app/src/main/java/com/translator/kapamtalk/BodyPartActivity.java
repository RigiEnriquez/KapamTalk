...
public class BodyPartActivity extends AppCompatActivity {
    ...
    private static final String ACTIVITY_ID = "activity5"; // Activity 5 for body parts
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bodyparts_activity); // Layout for body parts activity
    ...
    private List<Question> createQuestionsList() {
        ...
        questionsList.add(new Question("bp1", "What is the Kapampangan word for 'Head'?",
                Question.TYPE_MULTIPLE_CHOICE,
                Arrays.asList("Mata", "Lupa", "Buntuk", "Bitis"), "Buntuk"));

        questionsList.add(new Question("bp2", "Which body part is called 'Arung'?",
                Question.TYPE_MULTIPLE_CHOICE,
                Arrays.asList("Eyes", "Ears", "Mouth", "Nose"), "Nose"));

        questionsList.add(new Question("bp3", "The Kapampangan term 'Asbuk' refers to which body part?",
                Question.TYPE_MULTIPLE_CHOICE,
                Arrays.asList("Mouth", "Teeth", "Tongue", "Lips"), "Mouth"));

        questionsList.add(new Question("bp4", "What is the Kapampangan word for 'Teeth'?",
                Question.TYPE_MULTIPLE_CHOICE,
                Arrays.asList("Dila", "Ipan", "Asbuk", "Lupa"), "Ipan"));

        questionsList.add(new Question("bp5", "Which of these is the Kapampangan word for 'Finger'?",
                Question.TYPE_MULTIPLE_CHOICE,
                Arrays.asList("Gamat", "Taliri", "Panuldu", "Tindaragul"), "Taliri"));

        questionsList.add(new Question("bp6", "'Pusad' refers to which body part?",
                Question.TYPE_MULTIPLE_CHOICE,
                Arrays.asList("Chest", "Stomach", "Navel", "Hips"), "Navel"));

        questionsList.add(new Question("bp7", "What is the Kapampangan word for 'Knee'?",
                Question.TYPE_MULTIPLE_CHOICE,
                Arrays.asList("Tud", "Lulud", "Puad", "Butit"), "Tud"));

        questionsList.add(new Question("bp8", "Which body part is called 'Buldit'?",
                Question.TYPE_MULTIPLE_CHOICE,
                Arrays.asList("Hips", "Thighs", "Buttocks", "Lower leg"), "Buttocks"));

        questionsList.add(new Question("bp9", "The Kapampangan term 'Salu' refers to which body part?",
                Question.TYPE_MULTIPLE_CHOICE,
                Arrays.asList("Chest", "Neck", "Shoulders", "Back"), "Chest"));

        questionsList.add(new Question("bp10", "The term 'Takde' in Kapampangan refers to:",
                Question.TYPE_MULTIPLE_CHOICE,
                Arrays.asList("Lower Arm", "Upper Arm", "Wrist", "Forearm"), "Upper Arm"));

        questionsList.add(new Question("bp11", "The Kapampangan word for 'Face' is ______.",
                Question.TYPE_FILL_BLANK, null, "Lupa"));

        questionsList.add(new Question("bp12", "______ is the Kapampangan term that refers to the upper part of the face (forehead).",
                Question.TYPE_FILL_BLANK, null, "Kanuan"));

        questionsList.add(new Question("bp13", "The body part that connects the head to the body is called ______ in Kapampangan.",
                Question.TYPE_FILL_BLANK, null, "Batal"));

        questionsList.add(new Question("bp14", "______ is the Kapampangan word for 'Tongue'.",
                Question.TYPE_FILL_BLANK, null, "Dila"));

        questionsList.add(new Question("bp15", "The Kapampangan term for 'Finger Nails' is ______.",
                Question.TYPE_FILL_BLANK, null, "Kuku"));

        questionsList.add(new Question("bp16", "In Kapampangan, the term for 'Elbow' is ______.",
                Question.TYPE_FILL_BLANK, null, "Siku"));

        questionsList.add(new Question("bp17", "_____ refers to the lower abdominal region in Kapampangan.",
                Question.TYPE_FILL_BLANK, null, "Atiyan"));

        questionsList.add(new Question("bp18", "The Kapampangan word for 'Shoulder' is ______.",
                Question.TYPE_FILL_BLANK, null, "Pago"));

        questionsList.add(new Question("bp19", "In Kapampangan, ______ refers to the front part of the lower leg.",
                Question.TYPE_FILL_BLANK, null, "Lulud"));

        questionsList.add(new Question("bp20", "The back of the neck is called ______ in Kapampangan.",
                Question.TYPE_FILL_BLANK, null, "Tundun"));
    ...
    private void goToLogin() {
        ...
        Intent intent = new Intent(BodyPartActivity.this, Login.class);
