...
public class BodyPartItem {
    ...
    public BodyPartItem(String kapampangan, String english, String pronunciation, String usage,
                        String audioUrl, String referenceLocator,
                        String example, String translated) {
