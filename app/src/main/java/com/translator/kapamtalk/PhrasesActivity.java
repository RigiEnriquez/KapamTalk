...
public class PhrasesActivity extends AppCompatActivity {
    ...
    private static final String ACTIVITY_ID = "activity3"; // Changed to activity3 for phrases
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.phrases_activity); // You'll need to create this layout
    ...
    private List<Question> createQuestionsList() {
        ...
        questionsList.add(new Question("p1", "How do you say 'How much is this?' in Kapampangan?",
                Question.TYPE_MULTIPLE_CHOICE,
                Arrays.asList("Nanu ing pengan mu?", "Pilan na ka banwa?", "Nokarin ka munta?", "Magkanu ini?"), "Magkanu ini?"));

        questionsList.add(new Question("p2", "Its usage is mostly for negative response.",
                Question.TYPE_FILL_BLANK, null, "Ali"));

        questionsList.add(new Question("p3", "What does 'Mangan ta na' mean?",
                Question.TYPE_MULTIPLE_CHOICE,
                Arrays.asList("Good morning", "How much is this?", "Let's go", "Let's eat"), "Let's eat"));

        questionsList.add(new Question("p4", "How do you say 'I'm here' in Kapampangan?",
                Question.TYPE_MULTIPLE_CHOICE,
                Arrays.asList("Atiu na ku", "Tara na", "Buri ke ini", "Eku balu"), "Atiu na ku"));

        questionsList.add(new Question("p5", "Complete the phrase in Kapampangan: '____' (I like this)",
                Question.TYPE_FILL_BLANK, null, "Buri ke ini"));

        questionsList.add(new Question("p6", "It is used when someone wants to express or has intention to purchase.",
                Question.TYPE_MULTIPLE_CHOICE,
                Arrays.asList("Tuknang", "Saliwan ke ini", "Lagwa", "Lakwan da ka"), "Saliwan ke ini"));

        questionsList.add(new Question("p7", "What does 'Pilan na ka banwa?' mean?",
                Question.TYPE_MULTIPLE_CHOICE,
                Arrays.asList("What is your name?", "How are you?", "How old are you?", "Who are you?"), "How old are you?"));

        questionsList.add(new Question("p8", "Complete the phrase in Kapampangan: '____' (Take care)",
                Question.TYPE_FILL_BLANK, null, "Mimingat ka"));

        questionsList.add(new Question("p9", "It is used to command to halt.",
                Question.TYPE_MULTIPLE_CHOICE,
                Arrays.asList("Wa", "Tuknang", "Ali", "Galo"), "Tuknang"));

        questionsList.add(new Question("p10", "How do you say 'Yes' in Kapampangan?",
                Question.TYPE_MULTIPLE_CHOICE,
                Arrays.asList("Ali", "Wa", "Eku balu", "Mayap"), "Wa"));

        questionsList.add(new Question("p11", "Complete the phrase for 'No' in Kapampangan: '____'",
                Question.TYPE_FILL_BLANK, null, "Ali"));

        questionsList.add(new Question("p12", "What does 'Nokarin ka munta?' mean in English?",
                Question.TYPE_MULTIPLE_CHOICE,
                Arrays.asList("What is your name?", "How are you?", "Where are you going?", "Who are you?"), "Where are you going?"));

        questionsList.add(new Question("p13", "How do you say 'What have you eaten?' in Kapampangan?",
                Question.TYPE_MULTIPLE_CHOICE,
                Arrays.asList("Mengan na ka?", "Magkanu ini?", "Nanu ing pengan mu?", "Nanung panayan mu?"), "Nanu ing pengan mu?"));

        questionsList.add(new Question("p14", "Its usage is to command to increase speed.",
                Question.TYPE_FILL_BLANK, null, "Lagwa"));

        questionsList.add(new Question("p15", "What is the appropriate Kapampangan term if you are asking for directions?",
                Question.TYPE_MULTIPLE_CHOICE,
                Arrays.asList("Salamat", "Pauli na", "Saliwan ke ini", "Makananu munta king"), "Makananu munta king"));

        questionsList.add(new Question("p16", "How do you say 'Let's go home' in Kapampangan?",
                Question.TYPE_MULTIPLE_CHOICE,
                Arrays.asList("Mako na ka", "Muli ta na", "Mangan ta na", "Munta ka karin"), "Muli ta na"));

        questionsList.add(new Question("p17", "It is used to express concern for someone's safety. What Kapampangan term is it?",
                Question.TYPE_FILL_BLANK, null, "Mimingat ka"));

        questionsList.add(new Question("p18", "Its used to offer assitance. What Kapampangan term is it?",
                Question.TYPE_MULTIPLE_CHOICE,
                Arrays.asList("Nanung maliari kung daptan keka?", "Pilan na ka banwa?", "Nanu ing pengan mu?", "Nanung panayan mu?"), "Nanung maliari kung daptan keka?"));

        questionsList.add(new Question("p19", "What is the appropriate Kapampangan term if you are asking about what someone is waiting for?",
                Question.TYPE_MULTIPLE_CHOICE,
                Arrays.asList("Makananu munta king?", "Magkanu ini?", "Nanung panayan mu?", "Nanung maliari kung daptan keka?"), "Nanung panayan mu?"));

        questionsList.add(new Question("p20", "Complete the phrase in Kapampangan: '____' (You can go/leave)",
                Question.TYPE_FILL_BLANK, null, "Mako na ka"));
    ...
    private void goToLogin() {
        ...
        Intent intent = new Intent(PhrasesActivity.this, Login.class);
